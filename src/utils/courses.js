...
const COURSES = [
  ...
  { name: 'Black Stork - Veľká Lomnica (BRAID-VARDON)',   white: null, yellow: -1  },
  { name: 'Black Stork - Veľká Lomnica (TAYLOR-BRAID)',   white: null, yellow: -3  },
  { name: 'Black Stork - Veľká Lomnica (TAYLOR-VARDON)',  white: null, yellow: -1  },
  ...
  { name: 'Royal Valley Malý Slavkov',                    white: -3,  yellow:  3  },
...
export const TEE_LABELS = { white: 'Biele', yellow: 'Žlté' }
